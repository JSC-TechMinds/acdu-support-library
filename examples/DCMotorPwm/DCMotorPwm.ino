...
#define MOTOR_IN1 MOTOR_DRIVER::OUTPUT::ANALOG::PIN_IN1
#define MOTOR_IN2 MOTOR_DRIVER::OUTPUT::ANALOG::PIN_IN2
#define MOTOR_EN  MOTOR_DRIVER::OUTPUT::DIGITAL::PIN_NSLEEP
